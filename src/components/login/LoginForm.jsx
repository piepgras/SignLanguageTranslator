                ...
                <div className="row m-5">
                    ...
                    <div className="col">
                        ...
                        <div className="input-group mb-3 shadow">
                            ...
                            <input className="control form-control" type="text" {...register("username", { required: true, maxLength: 25 })} placeholder="What is your name?"/>
                        ...
                        <div>
                            ...
                            {(errors.username && errors.username.type === 'maxLength') && <span className="text-light m-2">User name too long (max. 25)!</span>}
                        </div>
                    </div>
                    <div className="col-2"></div>
                </div>
